...
const ArticlePage = ({ pageProps }) => {
    ...
    const { likesCount, onLike, like } = useLike(post);
    useEffect(() => {
                ...
                <Container className="flex mt-[2em] lg:mt-[3.8em] flex-col lg:flex-row lg:space-x-[30px]  gap-y-16    items-start">
                    <div className="flex-1">
                        ...
                        <div className="space-y-[2.5em] py-[2.5em]">
                            ...
                            <div className="flex flex-wrap items-end justify-between space-y-3">
                                <div className="transition-opacity cursor-pointer group active:opacity-60 ">
                                    <button
                                        onClick={() => {
                                            onLike();
                                        }}
                                        className="inline-flex rounded w-[46px] duration-1000 h-[46px] bg-[#E5D8CE] align-middle mr-[12px] text-[#720f21] group-hover:text-white  justify-center items-center">
                                        {!like ? (
                                            <svg
                                                stroke="currentColor"
                                                fill="currentColor"
